...
Route::resource('/adminpanel/outcomes','OutcomeController');
Route::get('/adminpanel/accounts','AccountController@index');
...
Route::get('/adminpanel/inv/form/{id}','InvoiceController@show');
